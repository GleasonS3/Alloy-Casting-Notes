...
\item Note: after completing this heating cycle there will be a small amount of slag floating on top of the melt. Poring should be done such that the slag remaining in the crucible and does not enter the casting as slag has undesirable properties. 
\end{itemize}